  ...
  return (
    <div className="space-y-8 w-full">
      ...
      <form onSubmit={handleEmailLogin} className="space-y-6">
        ...
        <Button type="button" variant="outline" onClick={handleGoogleLogin} disabled={isLoading} className="w-full h-12 rounded-xl border-2 font-semibold hover:bg-accent">
      ...
      <p className="text-center text-sm font-medium text-muted-foreground mt-4">
        Don't have an admin account? <Link to="/admin/signup" className="text-primary hover:underline font-bold">Sign up</Link>
      </p>
